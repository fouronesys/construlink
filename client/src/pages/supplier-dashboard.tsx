      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 h-auto">
            <TabsTrigger value="overview" data-testid="tab-overview" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Resumen</TabsTrigger>
            <TabsTrigger value="products" data-testid="tab-products" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Productos</TabsTrigger>
            <TabsTrigger value="publications" data-testid="tab-publications" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Publicaciones</TabsTrigger>
            <TabsTrigger value="advertisements" data-testid="tab-advertisements" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Anuncios</TabsTrigger>
            <TabsTrigger value="quotes" data-testid="tab-quotes" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Cotizaciones</TabsTrigger>
            <TabsTrigger value="profile" data-testid="tab-profile" className="text-xs sm:text-sm px-2 py-2 whitespace-normal h-auto min-h-[2.5rem]">Perfil</TabsTrigger>
          </TabsList>
